...
def main():
    ...
    if args.method == 'DANN':
        search_space = {
            ...
            'lr': {'_type': 'choice', '_value': [0.007, 0.003]},
            'alphamin': {'_type': 'choice', '_value': [1, 0.1]},
            'alphatimes': {'_type': 'choice', '_value': [1, 1.5]},
            'opt_decay_step': {'_type': 'choice', '_value': [50]},
            'opt_decay_rate': {'_type': 'choice', '_value': [0.8]},
            'rw_lmda' : {'_type': 'choice', '_value': [1]},
            'num_layers':  {'_type': 'choice', '_value': [1]},
            'dc_layers': {'_type': 'choice', '_value': [2]},
    ...
    elif args.method == 'DANN_rw':
        search_space = {
            'epochs': {'_type': 'choice', '_value': [300]},
            'lr': {'_type': 'choice', '_value': [0.007]},
            'alphamin': {'_type': 'choice', '_value': [1]},
            'alphatimes': {'_type': 'choice', '_value': [1.5]},
            'opt_decay_step': {'_type': 'choice', '_value': [50]},
            'opt_decay_rate': {'_type': 'choice', '_value': [0.8]},
            'num_layers':  {'_type': 'choice', '_value': [0]},
            'dc_layers': {'_type': 'choice', '_value': [2]},
            'class_layers': {'_type': 'choice', '_value': [1]},
            'K': {'_type': 'choice', '_value': [2]},
            'dropout': {"_type": "choice", "_value": [0.1]},
            #'weight_decay': {"_type": "uniform", "_value": [0, 1e-3]},
            'start_epoch': {'_type': 'choice', '_value': [100]},
            'rw_freq': {'_type': 'choice', '_value': [15]},
    ...
    if args.gpu_loc == 'later':
        ...
        experiment.config.training_service.gpu_indices = [3, 6, 7]
